#!/usr/bin/env python3
"""Simple test script to call Snov.io API directly without complex imports."""
...
if __name__ == "__main__":
    print("Snov.io Simple Test Script")
    print("=" * 40)
    ...
    confirm = input(f"\nProcess {COMPANIES_TO_TEST} companies? (y/N): ").strip().lower()
