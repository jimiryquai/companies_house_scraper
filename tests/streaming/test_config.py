...
class TestStreamingConfig:
    ...
    def test_invalid_api_key(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            StreamingConfig(streaming_api_key="short")
    ...
    def test_invalid_max_retries(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            StreamingConfig(streaming_api_key="test-api-key-123456", max_retries=15)
    ...
    def test_invalid_log_level(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            StreamingConfig(streaming_api_key="test-api-key-123456", log_level="INVALID")

        assert "log_level must be one of" in str(exc_info.value)

    def test_default_values(self) -> None:
        """Test that default values are correctly set."""
        config = StreamingConfig(streaming_api_key="test-api-key-123456")
