...
class DatabaseMigration:
    ...
    def migration_001_fix_officers_schema(self) -> None:
        """
        Migration 001: Fix officers table schema mismatch.
        
        - Rename 'role' column to 'officer_role' to match officer_import.py expectations
        ...
        try:
            ...
            # Check current officers table structure
            ...
            conn.commit()
            logger.info("Migration 001 completed: Fixed officers table schema")
    ...
    def run_migrations(self) -> None:
        ...
        migrations = [
            (1, self.migration_001_fix_officers_schema),
